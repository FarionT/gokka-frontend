    ...
    <div className="tentang">
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="gradient-gold font-bold text-4xl w-fit mx-auto pb-8">
              Berdiri Sejak 2021
            </div>
      ...
      {/* fakta singkat */}
      <div className="tentang-fakta p-8">
      ...
      <div className="px-8 pt-8 py-16">
        ...
        <div className="flex gradient-gold w-fit mx-auto font-bold text-4xl pb-8">Produk Kami Halal</div>
