...
const AdminModal: FC<ModalProps> = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div>
      ...
      <div className="modal fixed inset-0 z-50 flex m-auto items-center">
        <div
          ref={modalRef} // Attach ref to the modal content container
          className="relative rounded-xl shadow-2xl w-full h-fit transform transition-all duration-300 ease-out opacity-0 animate-scale-in" // Initial state for animation
